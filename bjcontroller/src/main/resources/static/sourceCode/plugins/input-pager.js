...
(function( $, undefined ) {
    ...
    $.widget( "ui.inputPager", {
                ...
                options : {
                    ...
                    limit : 10,
                    buttonIconStart : 'ui-icon-seek-first',
                ...
                _renderPager : function(limit) {
                	...
                	var select = $("<select>/select>"),array=self.options.maxPageLimit.split(','),limit = parseInt(!limit?array[0]:limit);
                    ...
                    var input = $('<li class="jwui-pager-input-li">'
                    		...
                    		+'" class="ui-widget ui-corner-all ui-widget-content jwui-pager-input" style="display:none;">'+self.options.pageNumber+'/'
                    		+self.pageCount+'</li>');
                    ...
                    //绑定事件
                    self._on( input.find('input'), {
                        keydown : "_doInputCallback"
                    } );
                    self._btnState(self.options.pageNumber);
                },
                _pageMsg : function(limit){
                	var self=this,array=self.options.maxPageLimit.split(','),limit = parseInt(!limit?array[0]:limit);
                ...
                _doButtonCallback : function( event ) {
                    ...
                    var button = $( event.currentTarget ),pageInput = $(".jwui-pager-input", this.widget()),self=this;
                    ...
                    var pageNum,
                        pgFirst = $(".jwui-pager-pgFirst", self.widget()),pgPrev = $(".jwui-pager-pgPrev", self.widget()),
                    	pgEnd = $(".jwui-pager-pgEnd", self.widget()),pgNext = $(".jwui-pager-pgNext", self.widget());
                ...
                _btnState : function(pageNum){
                	var pgFirst = $(".jwui-pager-pgFirst", this.widget()),pgPrev = $(".jwui-pager-pgPrev", this.widget()),
                	pgEnd = $(".jwui-pager-pgEnd", this.widget()),pgNext = $(".jwui-pager-pgNext", this.widget());
                ...
                _init : function() {
                	var self=this,array=this.options.maxPageLimit.split(','),flag=false;
