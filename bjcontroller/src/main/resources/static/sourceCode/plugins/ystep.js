...
+function ($) { "use strict";
  ...
  Tooltip.prototype.getCalculatedOffset = function (placement, pos, actualWidth, actualHeight) {
    return placement == 'bottom' ? { top: pos.top + pos.height,   left: pos.left - actualWidth / 2 + 10} :
           placement == 'top'    ? { top: pos.top - actualHeight, left: pos.left - actualWidth / 2 + 10} :
           placement == 'left'   ? { top: pos.top + - actualHeight / 2 + 10, left: pos.left - actualWidth } :
        /* placement == 'right' */ { top: pos.top + - actualHeight / 2 + 10, left: pos.left + pos.width   }
  }
  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var logic = {
        size: {
          large: function($html){
	        var stepCount = $html.find("li").length;
	        var liWidth=100/stepCount;
	        var progressWidth=liWidth*(stepCount-1);
	        $html.css({
	          width: "101%"
	        });
			...
			$html.find(".ystep-container-steps").css({
	          width: '100%'
	        });
			$html.find(".ystep-container-steps li").css({
	          width: (liWidth)+'%'
	        });
